...
describe "Result":
    ...
    it "makes sure the keys of specs are tuples of int and tuple", meta, spec, with_normalise:
        res = spec.normalise(meta, {"specs": {(0, "blah"): with_normalise}})
        assert res.specs == {(0, ("blah",)): with_normalise}
